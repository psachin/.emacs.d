...
;;; concat all paths
(defvar emacs-home "/home/sachin/plang/elisp/crashcourse/"
...
;; load auto-complete
(add-to-list 'load-path (home emacs-home emacs-init-dir "plugins/auto-complete-1.3.1/"))
(require 'auto-complete-config)
(add-to-list 'ac-dictionary-directories (home emacs-home emacs-init-dir "plugins/auto-complete-1.3.1/ac-dict"))
(ac-config-default)
(auto-complete-mode t)

;; autopair
(load (home emacs-home emacs-init-dir "plugins/autopair.el"))
(require 'autopair)
(autopair-global-mode)

;; insert-shebang
(add-to-list 'load-path "/home/sachin/github/insert-shebang/")
...
;; ---------- magit ----------
;; magit stable 1.2.0
(add-to-list 'load-path (home emacs-home emacs-init-dir "plugins/magit-1.2.0/"))

;; magit latest master(development)
;; (add-to-list 'load-path "/home/sachin/github/magit/")
;; (add-to-list 'load-path "/home/sachin/github/magit/contrib") ;contributed libs
...
(setq yas-snippet-dirs
      '((home emacs-home emacs-init-dir "snippets")            ;; personal snippets
	))
...
;; multiple-cursors
(add-to-list 'load-path (home emacs-home emacs-init-dir "plugins/multiple-cursors/"))
...
;; /opt/emx24/share/emacs/24.3/lisp/org.tar.bz2

;; (add-to-list 'load-path "/home/sachin/Downloads/org-8.2.1/lisp")
;; (add-to-list 'load-path "/home/sachin/Downloads/org-8.2.1/contrib/lisp" t)
